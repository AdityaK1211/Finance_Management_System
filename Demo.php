<?php
 ...
 if(!isset($_SESSION['TId']))
 {
    ...
    $_SESSION['TId'] = $random;
    $Sid = intval($_GET['id']);
    $query="SELECT * FROM `fd_schemes` WHERE Sid='$Sid'";
    ...
    if($row == 1)
    {
        ...
        $Bankname=$data['Bank'];
        $Tenure=$data['Min_Tenure'];
        $Amount=$data['Min_Amount'];
        $Interest=$data['Interest'];
        $_SESSION['CustBankName']=$Bankname;
        $_SESSION['CustTenure']=$Tenure;
                ...
                <div class="col-lg-12 col-sm-6 col-md-6">
                    ...
                    <form id="form1" action="Transaction.php" method="Post">              
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <label class="col-form-label" id="currentDate" name="PaymentDate"></label>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-2">
