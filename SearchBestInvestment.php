            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-sm-6 col-md-6 text-center">
                    <div class="pricing-box">
                        ...
                        <a href="SearchBestInvestmentByInterest.php" target="_blank" class="btn btn-outline-dark btn-circled">View</a>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6 col-md-6 text-center">
                    <div class="pricing-box">
                        ...
                        <a href="SearchBestInvestmentByTenure.php" target="_blank" class="btn btn-outline-dark btn-circled">View</a>
                    </div>
                </div>
            </div>
        </div>
